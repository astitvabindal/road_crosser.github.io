...
{for(var i = 0, len = gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Resizable")).setSize(gdjs.evtTools.window.getWindowInnerWidth(), gdjs.evtTools.window.getWindowInnerHeight());
}
    ...
    gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDBackgroundPainterObjects1[i].drawRectangle(0, 0, gdjs.evtTools.window.getGameResolutionWidth(runtimeScene), gdjs.evtTools.window.getGameResolutionHeight(runtimeScene));
}
}{for(var i = 0, len = gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDIconObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDIconObjects1[i].setY((( gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDTextObjects1.length === 0 ) ? 0 :gdjs.evtsExt__ScreenOrientationChecker__ScreenOrientationChecker.ScreenOrientationChecker.prototype.doStepPostEventsContext.GDTextObjects1[0].getY()) - 150);
}
}}
